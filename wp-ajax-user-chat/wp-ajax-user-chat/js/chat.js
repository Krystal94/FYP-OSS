jQuery(document).ready(function(){
      ...
      // the code is not very clean, I just want to reuse it to manage multiple chatboxes
		...
		function get_chat(name){
			jQuery.post(the_ajax_script.ajaxurl, { method:'getchat', action: 'the_ajax_hook', uid: name }
			,
			function(response_from_the_action_functions){
				...
				if(response_from_the_action_functions){
					var obj = jQuery.parseJSON(response_from_the_action_functions);
					if(obj){
      ...
      jQuery(".chat").click(function(event, ui) {
